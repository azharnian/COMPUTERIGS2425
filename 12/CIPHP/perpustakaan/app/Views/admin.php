          ...
          <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="index.html">
              ...
              <b class="logo-icon ps-2">
                ...
                <!-- Dark Logo icon -->
                <img
                  src="templates/matrix-admin/assets/images/logo-icon.png"
                  alt="homepage"
                  class="light-logo"
                  width="25"
                />
              ...
              <span class="logo-text ms-2">
                <!-- dark Logo text -->
                <img
                  src="templates/matrix-admin/assets/images/logo-text.png"
                  alt="homepage"
                  class="light-logo"
                />
              </span>
              ...
              <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
              <!-- Dark Logo icon -->
              <!-- <img src="templates/matrix-admin/assets/images/logo-text.png" alt="homepage" class="light-logo" /> -->
          ...
          >
            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <img
                    src="templates/matrix-admin/assets/images/users/1.jpg"
                    alt="user"
              ...
              <div class="card">
                ...
                <div class="comment-widgets scrollable">
                  ...
                  <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                      <img
                        src="templates/matrix-admin/assets/images/users/4.jpg"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                  ...
                  <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                      <img
                        src="templates/matrix-admin/assets/images/users/5.jpg"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                        ...
                        <ul class="list-style-none assignedto">
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="templates/matrix-admin/assets/images/users/2.jpg"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="templates/matrix-admin/assets/images/users/3.jpg"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                ...
                <div class="card-body">
                  ...
                  <div class="chat-box scrollable" style="height: 475px">
                    ...
                    <ul class="chat-list">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="templates/matrix-admin/assets/images/users/1.jpg" alt="user" />
                        </div>
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="templates/matrix-admin/assets/images/users/2.jpg" alt="user" />
                        </div>
                        <div class="chat-content">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="templates/matrix-admin/assets/images/users/3.jpg" alt="user" />
                        </div>
                        <div class="chat-content">
                ...
                <div class="tab-content tabcontent-border">
                  <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="p-20">
                      ...
                      <img
                        src="templates/matrix-admin/assets/images/background/img4.jpg"
                        class="img-fluid"
                      />
                    </div>
                  </div>
